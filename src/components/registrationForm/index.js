  ...
  return (
    <div>
      <Formik
        ...
        >
        {({ errors, values, handleSubmit, handleChange, setFieldValue ,handleBlur }) => (
    ...
    <form onSubmit={handleSubmit}>
      <div className="row Register-form">
        <div className="col-lg-6 col-12">
          <div className="input-group input-group-sm mb-3">
            <label>Email:</label>
            <input type="email" className="form-control" name='email' onChange={handleChange} value={values.email} placeholder="email@email.com" aria-label="Sizing example input"
              aria-describedby="inputGroup-sizing-sm" />
          </div>
        </div>
        <div className="col-lg-6 col-12">
          <div className="input-group input-group-sm mb-3">
            ...
            <input type="text" className="form-control" name='password' onChange={handleChange} value={values.password} placeholder="" aria-label="Sizing example input"
              aria-describedby="inputGroup-sizing-sm" />
          </div>
      ...
      {validator(errors, values)? setProgress2(0) : setProgress2(1)}
    </form>
  )}
</Formik>
}
